...
scripts = [read('data/illustrations.js'), read('data/activities.js'), read('data/practice.js'), read('data/expansion.js'), read('data/fact-expansion.js'), read('data/option-pools.js'), read('data/true-false.js'), read('app.js')] + [read(p) for p in paths]
